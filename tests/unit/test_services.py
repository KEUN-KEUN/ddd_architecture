...
def test_allocate_returns_allocation():
    uow = FakeUnitOfWork()
    handlers.add_batch("b1", "ADORABLE-SETTEE", 100, None, uow)
    result = handlers.allocate("o1", "ADORABLE-SETTEE", 10, uow)
    # print("*********************************************")
    # print(result)
    # print("*********************************************")
...
def test_allocate_errors_for_invalid_sku():
    uow = FakeUnitOfWork()
    handlers.add_batch("b1", "AREASKU", 100, None, uow)
...
def test_allocate_commits():
    uow = FakeUnitOfWork()
    handlers.add_batch("b1", "ADORABLE-SETTEE", 100, None, uow)
    handlers.allocate("o1", "ADORABLE-SETTEE", 10, uow)
    assert uow.committed
